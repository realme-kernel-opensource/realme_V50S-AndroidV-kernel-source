    ...
    enum IMGSENSOR_HW_PIN_STATE pin_state)
{
    ...
    if (is_project(24699) || is_project(24601) || is_project(24683) ||
        ...
        is_project(24721) || is_project(24727) || is_project(24615) ||
        is_project(24722) || is_project(24723) || is_project(24710) ||
        is_project(24711) || is_project(24609) || is_project(24745) ||
        is_project(24746) || is_project(24617) || is_project(24747)) {
