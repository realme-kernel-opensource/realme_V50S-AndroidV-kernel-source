...
static void write_shutter(kal_uint32 shutter)
{
    ...
    LOG_INF("write_shutter _is_binning_size %d shutter %d lastshutter %d %d frame_length %d",_is_binning_size,shutter,imgsensor.lastshutter,imgsensor.shutter,imgsensor.frame_length);
	if(_is_binning_size) {
