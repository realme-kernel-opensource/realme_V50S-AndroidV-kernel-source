...
** File: oplus24251_ds_ili9883c_hd_dsi_vdo.c
...
#include "../mediatek/mediatek_v2/mtk_corner_pattern/oplus24251_ds_ili9883c_data_hw_roundedpattern.h"
/* #endif */
#include "include/oplus24251_ds_ili9883c_hd_dsi_vdo.h"
#include "../bias/oplus23661_aw37501_bias.h"
#include <linux/reboot.h>

#define MAX_NORMAL_BRIGHTNESS    (3586)
...
static int lcm_panel_poweroff(struct drm_panel *panel)
{
	...
	pr_err("[TP]  oplus24251_ds_ili9883c_hd_dsi_vdo_lcm_drv g_shutdown_flag is %d, esd_flag is %d\n", g_shutdown_flag, esd_flag);
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "oplus24251_al5", "ds_ili9883c");
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus24251_ds_ili9883c_hd_dsi_vdo",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("oplus24251 ds ili9883c Panel Driver");
