 ...
 ** OPLUS_EDIT
 ** File: oplus24615_txd_ili9883c_hd_dsi_vdo.h
...
#endif
#include "oplus24615_txd_ili9883c_hd_dsi_vdo.h"
...
#define VAC (1604)
#define HAC (720)
#define VFP_50hz (3150)
#define VFP_60hz (2356)
#define VFP_90hz (1026)
#define VFP_120hz (358)
...
static struct mtk_panel_params ext_params_50hz = {
                ...
                .manufacture = "24615_txd_ili9883c",
                .cust_esd_check = 1,
                .esd_check_enable = 1,
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
        ...
        pr_info("%s+ jdi_probe enter txd,ili9883c,vdo,120hz\n", __func__);
	...
	register_device_proc("lcd", "ili9883c_rado", "24615_txd_ili9883c");
...
static const struct of_device_id jdi_of_match[] = {
        {
                .compatible = "oplus24615,txd,ili9883c,hd,dsi,vdo",
        },
        {
        }
};
...
static struct mipi_dsi_driver jdi_driver = {
        ...
        .remove = jdi_remove,
        .driver = {
                .name = "oplus24615_txd_ili9883c_hd_dsi_vdo",
                .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("TXD ILI9883C VDO 120HZ LCD Panel Driver");
